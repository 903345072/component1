...
class Home extends Base
{
    ...
    public function mobile()
    {
     ...
     {
         $this->assign('type', 3);
         return view('public/rookie');
     }
     public function issue()
     {
         $this->assign('type', 4);
         return view('public/issue');
     }
     public function wt1()
     {
         $this->assign('type', 4);
         return view('public/wt1');
     }
     public function wt2()
     {
         $this->assign('type', 4);
         return view('public/wt2');
     }
     public function wt3()
     {
         $this->assign('type', 4);
         return view('public/wt3');
     }
     public function wt4()
     {
         $this->assign('type', 4);
         return view('public/wt4');
     }
     public function wt5()
     {
         $this->assign('type', 4);
         return view('public/wt5');
     }
