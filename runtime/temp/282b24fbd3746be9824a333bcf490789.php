<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/admin/view/hot/modify.html";i:1568109530;s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/application/admin/view/layouts/layout_iframe.html";i:1568109530;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-team-user-add">
        <input type="hidden" name="id" value="<?php echo $hot['id']; ?>">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>股票代码：</label>
            <div class="formControls col-xs-8 col-sm-7">
                <input type="text" class="input-text" value="<?php echo (isset($hot['code']) && ($hot['code'] !== '')?$hot['code']:''); ?>" placeholder="股票代码/名称（例：600000）" name="code" id="code">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7">
                <input type="text" class="input-text" value="<?php echo (isset($hot['sort']) && ($hot['sort'] !== '')?$hot['sort']:50); ?>" placeholder="50" name="sort">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7 skin-minimal">
                <div class="radio-box">
                    <input name="status" type="radio" value="0" id="sex-1" <?php if($hot['status']['value'] == 0): ?>checked<?php endif; ?>>
                    <label for="sex-1">开启</label>
                </div>
                <div class="radio-box">
                    <input type="radio" name="status" id="sex-2" value="1" <?php if($hot['status']['value'] == 1): ?>checked<?php endif; ?>>
...
$(function(){
    ...
    $("#bth-submit").click(function(){
        var _oData = $("form").serialize(),
            _url = '<?php echo url("admin/Hot/modify"); ?>',
