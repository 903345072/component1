<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/admin/view/record/defer.html";i:1568109530;s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/application/admin/view/layouts/layout_iframe.html";i:1568109530;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="text-l">
        ...
        <input type="text" class="input-text radius" style="width:100px;" placeholder="策略ID" name="orderId" value="<?php echo (isset($search['orderId']) && ($search['orderId'] !== '')?$search['orderId']:''); ?>">
    ...
    <div class="text-l mt-5"></div>
        ...
        <span class="select-box radius" style="width:100px;height: 31px;">
            <select class="select radius" name="type" size="1">
                ...
                <option value="0" <?php if(isset($search['type']) AND $search['type'] === '0'): ?>selected<?php endif; ?>>余额扣除</option>
                <option value="1" <?php if(isset($search['type']) AND $search['type'] === '1'): ?>selected<?php endif; ?>>保证金扣除</option>
            </select>
        </span>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
            <span class="c-blue">递延费总计： <strong>￥<?php echo number_format($totalMoney,2); ?></strong></span>
        </span>
