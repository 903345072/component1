<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/admin/view/user/lists.html";i:1568109530;s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/application/admin/view/layouts/layout_iframe.html";i:1568109530;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <table class="table table-border table-bordered table-hover table-bg">
        ...
        <tbody>
            ...
            <tr class="text-c admin-lists">
                ...
                <td class="f-14">
                    <?php if(in_array('admin/User/modify', \think\Session::get('ACCESS_LIST'))): ?>
                    <input class="btn btn-primary size-MINI radius" type="button" title="会员编辑" onclick="admin_edit('会员编辑','<?php echo url("admin/User/modify", ['user_id' => $item['user_id']]); ?>','','500')" value="编辑">
                    <?php endif; if(in_array('admin/User/modifyPwd', \think\Session::get('ACCESS_LIST'))): ?>
                    <input class="btn btn-warning size-MINI radius" type="button" title="修改密码" onclick="admin_pwd(this, '<?php echo $item['user_id']; ?>')" value="修改密码">
                    <?php endif; ?>
                </td>
            </tr>
            ...
            <tr class="text-c admin-lists">
                ...
                <td><strong><?php echo number_format($pageAccount,2); ?></strong></td>
                <td>-</td>
                <td>-</td>
                <td>-</td>
            </tr>
            <tr class="text-c admin-lists">
                ...
                <td><strong><?php echo number_format($totalAccount,2); ?></strong></td>
                <td>-</td>
                <td>-</td>
                <td>-</td>
            </tr>
...
<script>
    ...
    function admin_pwd(_obj, _id)
    {
        layer.prompt({
            ...
            layer.close(_prompt);
            var _oData = {user_id : _id, password : _number},
                _url = '<?php echo url("admin/User/modifyPwd"); ?>',
