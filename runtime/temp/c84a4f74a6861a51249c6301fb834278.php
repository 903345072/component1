<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/index/view/order/entrust.html";i:1568109530;s:84:"/www/wwwroot/125.maoerle.cn/www_fuda/application/index/view/layouts/layout_user.html";i:1568109530;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
	...
	//选项卡
     ...
     $("body").on("tap", ".sell_position_btn", function(){
        var id = $(this).data("id");
        var _url = '<?php echo url("index/Order/cancel"); ?>',
            _oData = {id: id};
        var that = this;
    ...
    function initData(me){
        ...
        var _url = "<?php echo url('index/Order/entrust'); ?>",
            _oData = {page: now};
        $ajaxCustom(_url, _oData, function(res){
          if(res.state == 1){ // 成功
            now ++;
            ...
            for(var key in data.orders){
                ...
                if( data.orders[key].state == 1){
                    ...
                    <div class="clear_fl p_control_panel">\
                        <p class="rt">\
                            <span class="sell_position_btn lf" data-id="' + data.orders[key].order_id +'">撤销</span>\
                        </p>\
                    </div>\
                </li>';
