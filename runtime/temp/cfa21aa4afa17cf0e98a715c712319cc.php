<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/admin/view/mode/modify.html";i:1568109530;s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/application/admin/view/layouts/layout_iframe.html";i:1568109530;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form-team-user-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7">
                <input type="text" class="input-text" value="<?php echo $mode['name']; ?>" placeholder="" name="name">
            </div>
        </div>
        <div class="row cl">
			...
			<select class="select" name="product_id" size="1">
                ...
                <option value="<?php echo $item['id']; ?>" <?php if($mode['product_id'] == $item['id']): ?>selected<?php endif; ?>><?php echo $item['name']; ?></option>
        ...
        <div class="row cl">
			...
			<select class="select" name="plugins_code" size="1">
                ...
                <option value="<?php echo $item['code']; ?>" <?php if($mode['plugins_code'] == $item['code']): ?>selected<?php endif; ?>><?php echo $item['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
			</span> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7">
                <input type="text" class="input-text" value="<?php echo $mode['free']; ?>" placeholder="" name="free">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7">
                <input type="text" class="input-text" value="<?php echo $mode['jiancang']; ?>" placeholder="" name="jiancang">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7">
                <input type="text" class="input-text" value="<?php echo $mode['defer']; ?>" placeholder="" name="defer">
        ...
        <!-- <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7">
                <input type="text" class="input-text" value="<?php echo $mode['profit']; ?>" placeholder="" name="profit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7">
                <input type="text" class="input-text" value="<?php echo $mode['loss']; ?>" placeholder="" name="loss">
                <p class="textarea-numberbar" style="color: #b3abab;">%</p>
            </div>
        </div> -->
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7">
                <input type="text" class="input-text" value="<?php echo $mode['point']; ?>" placeholder="" name="point">
                <p class="textarea-numberbar" style="color: #b3abab;">%</p>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7">
                <input type="text" class="input-text" value="<?php echo $mode['sort']; ?>" placeholder="50" name="sort">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-7 skin-minimal">
                <div class="radio-box">
                    <input name="status" type="radio" value="0" id="sex-1" <?php if($mode['status']['value'] == 0): ?>checked<?php endif; ?>>
                    <label for="sex-1">开启</label>
                </div>
                <div class="radio-box">
                    <input type="radio" name="status" id="sex-2" value="1" <?php if($mode['status']['value'] == 1): ?>checked<?php endif; ?>>
...
$(function(){
    ...
    $("#bth-submit").click(function(){
        var _oData = $("form").serialize(),
            _url = '<?php echo url("admin/Mode/modify"); ?>',
