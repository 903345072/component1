<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/admin/view/record/proxy.html";i:1568109530;s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/application/admin/view/layouts/layout_iframe.html";i:1568109530;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 代理商返点记录
...
<div class="page-container">
    ...
    <div class="text-l">
        <input type="text" class="input-text radius" style="width:170px;" placeholder="代理商" name="nickname" value="<?php echo (isset($search['nickname']) && ($search['nickname'] !== '')?$search['nickname']:''); ?>">
        <span class="select-box radius" style="width:110px;height: 31px;">
            <select class="select radius" name="role" size="1">
                ...
                <option value="<?php echo $key; ?>" <?php if(isset($search['role']) AND $search['role'] == $key): ?>selected<?php endif; ?>><?php echo $item; ?></option>
    ...
    <table class="table table-border table-bordered table-hover table-bg">
        ...
        <tr class="text-c admin-lists">
            <td><?php echo (isset($item['belongs_to_admin']['nickname']) && ($item['belongs_to_admin']['nickname'] !== '')?$item['belongs_to_admin']['nickname']:$item['belongs_to_admin']['username']); ?></td>
            <td><?php echo $item['role_text']; ?></td>
