<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/admin/view/record/manager.html";i:1568109530;s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/application/admin/view/layouts/layout_iframe.html";i:1568109530;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 经纪人返点记录
...
<div class="page-container">
    ...
    <div class="text-l">
        <input type="text" class="input-text radius" style="width:170px;" placeholder="经纪人" name="nickname" value="<?php echo (isset($search['nickname']) && ($search['nickname'] !== '')?$search['nickname']:''); ?>">
    ...
    <div class="text-l mt-5">
        ...
        <span class="select-box radius" style="width:110px;height: 31px;">
            <select class="select radius" name="type" size="1">
                ...
                <option value="0" <?php if(isset($search['type']) AND $search['type'] === '0'): ?>selected<?php endif; ?>>盈利分成</option>
                <option value="1" <?php if(isset($search['type']) AND $search['type'] === '1'): ?>selected<?php endif; ?>>建仓费分成</option>
                <option value="2" <?php if(isset($search['type']) AND $search['type'] === '2'): ?>selected<?php endif; ?>>递延费分成</option>
            </select>
        </span>
    ...
    <table class="table table-border table-bordered table-hover table-bg">
        ...
        <tr class="text-c admin-lists">
            <td><?php echo (isset($item['belongs_to_manager']['nickname']) && ($item['belongs_to_manager']['nickname'] !== '')?$item['belongs_to_manager']['nickname']:$item['belongs_to_manager']['username']); ?></td>
            <td><?php echo $item['belongs_to_manager']['mobile']; ?></td>
            <td><?php echo (isset($item['belongs_to_manager']['has_one_admin']['username']) && ($item['belongs_to_manager']['has_one_admin']['username'] !== '')?$item['belongs_to_manager']['has_one_admin']['username']:'无'); ?></td>
            <td><?php echo (isset($item['belongs_to_manager']['has_one_admin']['has_one_parent']['username']) && ($item['belongs_to_manager']['has_one_admin']['has_one_parent']['username'] !== '')?$item['belongs_to_manager']['has_one_admin']['has_one_parent']['username']:'无'); ?></td>
