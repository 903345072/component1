<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/admin/view/team/ring.html";i:1568109530;s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/application/admin/view/layouts/layout_iframe.html";i:1568109530;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="text-c">
        ...
        <input type="text" class="input-text" style="width:170px;" placeholder="上级会员" name="member" value="<?php echo (isset($search['member']) && ($search['member'] !== '')?$search['member']:''); ?>">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
            ...
            <?php if(in_array('admin/Team/createRing', \think\Session::get('ACCESS_LIST'))): ?>
			<a class="btn btn-primary radius" href="javascript:;" onclick="admin_add('添加代理商','<?php echo url("admin/Team/createRing"); ?>','', '450')">
    ...
    <table class="table table-border table-bordered table-hover table-bg">
        ...
        <tr class="text-c admin-lists">
            ...
            <td class="f-14">
                <?php if(in_array('admin/Team/modifyRing', \think\Session::get('ACCESS_LIST'))): ?>
                <input class="btn btn-success size-MINI radius" type="button" title="修改代理商" onclick="admin_edit('编辑代理商','<?php echo url("admin/Team/modifyRing", ['id' => $item['admin_id']]); ?>','','450')" value="修改">
                <?php endif; if(in_array('admin/Team/ringPoint', \think\Session::get('ACCESS_LIST'))): ?>
                <input class="btn btn-primary size-MINI radius" type="button" title="返点修改" onclick="ring_point('返点修改','<?php echo url("admin/Team/ringPoint", ['id' => $item['admin_id']]); ?>','','340');" value="返点">
...
<script>
    ...
    <?php endif; if(in_array('admin/Team/modifyRing', \think\Session::get('ACCESS_LIST'))): ?>
    function admin_edit(title,url,w,h){
        layer_show(title,url,w,h);
    }
    <?php endif; if(in_array('admin/Team/ringPoint', \think\Session::get('ACCESS_LIST'))): ?>
    function ring_point(title,url,w,h){
        layer_show(title,url,w,h);
    }
    <?php endif; if(in_array('admin/Team/recharge', \think\Session::get('ACCESS_LIST'))): ?>
