<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/admin/view/team/settle.html";i:1568109530;s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/application/admin/view/layouts/layout_iframe.html";i:1568109530;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
            ...
            <?php if(in_array('admin/Team/createSettle', \think\Session::get('ACCESS_LIST'))): ?>
			<a class="btn btn-primary radius" href="javascript:;" onclick="admin_add('添加用户','<?php echo url("admin/Team/createSettle"); ?>','', '420')">
    ...
    <table class="table table-border table-bordered table-hover table-bg">
        ...
        <tr class="text-c admin-lists">
            ...
            <td class="f-14">
                <?php if(in_array('admin/Team/modifySettle', \think\Session::get('ACCESS_LIST'))): ?>
                <input class="btn btn-success size-MINI radius" type="button" title="结算中心修改" onclick="admin_edit('结算中心修改','<?php echo url("admin/Team/modifySettle", ['id' => $item['admin_id']]); ?>','','380')" value="修改">
                <?php endif; if(in_array('admin/Team/settlePoint', \think\Session::get('ACCESS_LIST'))): ?>
                <input class="btn btn-primary size-MINI radius" type="button" title="返点修改" onclick="settle_point('返点修改','<?php echo url("admin/Team/settlePoint", ['id' => $item['admin_id']]); ?>','','340');" value="返点">
...
<script>
    ...
    <?php endif; if(in_array('admin/Team/modifySettle', \think\Session::get('ACCESS_LIST'))): ?>
