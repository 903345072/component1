<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/admin/view/order/historyDetail.html";i:1568109530;s:86:"/www/wwwroot/125.maoerle.cn/www_fuda/application/admin/view/layouts/layout_iframe.html";i:1568109530;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	<div class="col-sm-8" style="float: none;margin: 0 auto;">
        <table class="table table-border table-bordered radius">
            <thead class="text-c">
                <tr>
                    <th class="f-14" colspan="4">策略详情</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <th class="text-r">平仓类型：</th>
                    <td class="text-l">
                        <?php if($order['force_type'] > '0'): ?>
                        强制平仓
                        <?php else: ?>
                        委托平仓
                        <?php endif; ?>
                    </td>
                    <th class="text-r">平仓备注：</th>
                    <td class="text-l">
                        <?php if($order['force_type'] > '0'): ?>
                        <?php echo $order['force_type_text']; else: ?>
                        -
                        <?php endif; ?>
                    </td>
                </tr>
                <tr>
                    <th class="text-r">买入价：</th>
                    <td class="text-l"><?php echo number_format($order['price'],2); ?></td>
                    <th class="text-r">买入数量：</th>
                    <td class="text-l"><?php echo intval($order['hand']); ?></td>
                </tr>
                <tr>
                    <th class="text-r">卖出价：</th>
                    <td class="text-l"><?php echo number_format($order['sell_price'],2); ?></td>
                    <th class="text-r">卖出数量：</th>
                    <td class="text-l"><?php echo intval($order['sell_hand']); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="text-l <?php if($order['profit'] < 0): ?>c-green<?php else: ?>c-red<?php endif; ?>">
                ...
                <tr>
                    ...
                    <th class="text-r">卖出时间：</th>
                    <td class="text-l"><?php echo date("Y-m-d H:i", $order['update_at']); ?></td>
                </tr>
                <tr>
