<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/125.maoerle.cn/www_fuda/public/../application/index/view/strategy/index.html";i:1568109530;s:84:"/www/wwwroot/125.maoerle.cn/www_fuda/application/index/view/layouts/layout_user.html";i:1568109530;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <header class="strategy_top">
        <p>
            ...
            <a href="<?php echo url('index/Order/position'); ?>">策略持仓</a>
        </p>
    </header>
    ...
    <div class="search_content_box">
        ...
        <div class="search_history hot_recommend" style="margin-top: 8px;">
            ...
            <ul class="recommend_list flex_nowrap">
                <?php if(is_array($hots) || $hots instanceof \think\Collection || $hots instanceof \think\Paginator): $i = 0; $__LIST__ = $hots;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if(isset($item['last_px'])): ?>
                <li data-code="<?php echo $item['code']; ?>" class="fresh<?php echo $item['code']; ?> hotItems">
                    <a href="<?php echo url('index/Stock/stockBuy', ['code' => $item['code']]); ?>">
                        <p class="shares_name"><?php echo $item['name']; ?></p>
                        <p class="shares_code"><?php echo $item['code']; ?></p>
                        <p class="shares_price"><?php echo $item['last_px']; ?></p>
                        <p class="shares_detail">
                            <span><?php echo $item['px_change']; ?></span>
                            <span><?php echo $item['px_change_rate']; ?>%</span>
                        </p>
                    </a>
                </li>
