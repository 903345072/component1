    ...
    var _url = refreshUrl,
        ...
        $ajaxCustom(_url, _oData, function(res){
            ...
            var html = '<div class="clear_fl g_info">\
                <div class="lf">\
                    <p class="'+pr1+'">' + res.data.last_px + '</p>\
                    <p class="'+pr2+' clear_fl">\
            ...
            <ul class="g_detail_list clear_fl">\
                ...
                <li>成交量 <span>'+ numberFormat(res.data.business_amount/100) +'手</span></li>\
                <li>成交额 <span>'+ numberFormat(res.data.business_balance) +'元</span></li>\
                <li>内盘 <span>'+ numberFormat(res.data.business_amount_in/100) +'手</span></li>\
                <li>外盘 <span>'+ numberFormat(res.data.business_amount_out/100) +'手</span></li>\
                <li>总市值 <span>'+ res.data.total_shares +'亿</span></li>\
                <li>市盈率 <span>'+ res.data.pe_rate +'</span></li>\
                <li>流通市值 <span>'+ res.data.circulation_value +'亿</span></li>\
            </ul>';
            $(".g_section").html( html );

            //修改盘口
            var html = '<ul class="sell mui-col-xs-6 mui-row clear_fl">\
                <li class=""><em>卖⑤</em><b class="red">'+ res.data.offer_grp[9] +'</b><i>'+ numbermm(res.data.offer_grp[8]) +'</i></li>\
                <li class=""><em>卖④</em><b class="red">'+ res.data.offer_grp[7] +'</b><i>'+ numbermm(res.data.offer_grp[6]) +'</i></li>\
                <li class=""><em>卖③</em><b class="red">'+ res.data.offer_grp[5] +'</b><i>'+ numbermm(res.data.offer_grp[4]) +'</i></li>\
                <li class=""><em>卖②</em><b class="red">'+ res.data.offer_grp[3] +'</b><i>'+ numbermm(res.data.offer_grp[2]) +'</i></li>\
                <li class=""><em>卖①</em><b class="red">'+ res.data.offer_grp[1] +'</b><i>'+ numbermm(res.data.offer_grp[0]) +'</i></li>\
            </ul>\
            <ul class="buy mui-col-xs-6 mui-row clear_fl">\
                <li><em>买①</em><b class="red">'+ res.data.bid_grp[1] +'</b><i>'+ numbermm(res.data.bid_grp[0]) +'</i></li>\
                <li><em>买②</em><b class="red">'+ res.data.bid_grp[3] +'</b><i>'+ numbermm(res.data.bid_grp[2]) +'</i></li>\
                <li><em>买③</em><b class="red">'+ res.data.bid_grp[5] +'</b><i>'+ numbermm(res.data.bid_grp[4]) +'</i></li>\
                <li><em>买④</em><b class="red">'+ res.data.bid_grp[7] +'</b><i>'+ numbermm(res.data.bid_grp[6]) +'</i></li>\
                <li><em>买⑤</em><b class="red">'+ res.data.bid_grp[9] +'</b><i>'+ numbermm(res.data.bid_grp[8]) +'</i></li>\
            </ul>';
...
$(function(){
    ...
    initAreaLine();
    /*** 没两秒请求数据， 更新页面 ****/
    freshInterval = setInterval(refreshTimeLine, 1000 * 2);
});
...
function initKline( type ){
    ...
    if( lineData[type] ){
        ...
        $ajaxCustom(_url, _oData, function(res){
            if(res.state){ 
                var _data = res.data.showapi_res_body.dataList;
...
function splieKNum(rawData){
    ...
    for (var i = rawData.length-1; i >= 0; i--) {
        ...
        values.push([rawData[i].open, rawData[i].close,  rawData[i].min, rawData[i].max, rawData[i].volumn, rawData[i].volumn]);
        var _count = "-";
        if(i != 0){
            _count = rawData[i].volumn / 1000000;
        }
        volumes.push([i, _count, rawData[i].open > rawData[i].close ? 1 : -1]);
    }
